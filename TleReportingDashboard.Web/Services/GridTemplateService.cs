...
public class GridTemplateService : IGridTemplateService
{
    ...
    public GridTemplateService(IConfiguration configuration)
    {
    ...
    public async Task<List<GridTemplate>> GetTemplatesAsync(string userId, Guid? connectionId = null)
    {
    ...
    public async Task<GridTemplate?> GetTemplateAsync(Guid id)
    {
        await using var conn = new SqlConnection(_connectionString);
        await conn.OpenAsync();
