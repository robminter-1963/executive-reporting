-- Rollback — restore the prior seed payload (without the
-- dashboardGrid* tokens). Touches only the bootstrap row so admin-saved
-- themes stay intact. Code-side rollback safe to run independently
-- because the C# defaults backfill missing keys.
